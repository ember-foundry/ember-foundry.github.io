...
import {BadgePlayfulEarthyDirective, ButtonPlayfulEarthyComponent} from 'component-library';
  ...
  decorators: [
    moduleMetadata({
      imports: [
        ...
        BadgePlayfulEarthyDirective,
        NgTemplateOutlet
      ]
    })
  ],
  tags: ['autodocs', 'badge', 'playful earthy'],
  argTypes: {
    button_size: {
...
export const PlayfulEarthRoundedButton: StoryObj = {
  args: {
...
export const PlayfulEarthBadgeOnIcon: StoryObj = {
  args: {
